...
public class BankLodgement implements Serializable {
    ...
    public BankLodgement() {
    }

    public BankLodgement(int lodgement_id, int customer_id, int account_id, int transaction_id, String from_card, String card_encryption, String transacrion_ref, double amount, String date, String time, boolean verified) {
